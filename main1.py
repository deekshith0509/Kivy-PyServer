...
# Define your custom colors if not already done
COLORS = {
...
class MainScreen(Screen):
    ...
    def show_snackbar(self, message: str, error: bool = False):
        ...
        snackbar = Snackbar(duration=2.5)
        snackbar.snackbar_x = "10dp"
        snackbar.snackbar_y = "10dp"
        snackbar.size_hint_x = (Window.width - dp(20)) / Window.width
        snackbar.padding = [dp(15), dp(10)]

        # Layout for icon + text
        box = BoxLayout(orientation="horizontal", spacing=dp(10), size_hint_x=0.9)
